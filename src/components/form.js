...
class myForm extends React.Component{
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        console.log('收到表单值: ', this.props.form.getFieldValue());
            ...
            <Form horizontal onSubmit={this.handleSubmit}>
                ...
                <FormItem
                   ...
                   required>
                    <Col span="2">
                        <FormItem>
                            <DatePicker {...getFieldProps('startData')} />
                        </FormItem>
                    </Col>
                    <Col span="1">
                ...
                <FormItem
                    ...
                    label="文本域"
                    {...formItemLayout}>
                    <Input type="textarea" id="control-textarea" row="3"
                ...
                <FormItem
                    ...
                    <Select id="select" size="large" defaultValue="lucy"
                            style={{width: 200}} onChange={this.handleSelectChange}
                            {...getFieldProps('people')}>
                        <Option value="jack">jack</Option>
                        <Option value="lucy" disabled>lucy</Option>
                        <Option value="sumetal">sumetal</Option>
                ...
                <FormItem
                    label="Checkbox 多选框"
                    {...formItemLayout}>
                    <Checkbox className="ant-checkbox-inline"
                              {...getFieldProps('checkboxItem1')}>选项一</Checkbox>
                    <Checkbox className="ant-checkbox-inline"
                              {...getFieldProps('checkboxItem2')}>选项二</Checkbox>
                    <Checkbox className="ant-checkbox-inline"
                              {...getFieldProps('checkboxItem3')}>选项三</Checkbox>
                </FormItem>
